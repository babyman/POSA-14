    ...
    static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
              ...
              String pathname = bundle.getString(DownloadUtils.PATHNAME_KEY);
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
          ...
          getApplicationContext().startService(
              DownloadIntentService.makeIntent(getApplicationContext(), handler, getUrlString())
          );
        ...
        case R.id.thread_pool_button:
            ...
            getApplicationContext().startService(
                ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, getUrlString())
            );
